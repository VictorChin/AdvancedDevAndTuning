-- Basically a copy of Demo_0.sql
-- This adds some native dynamic SQL to illustrate how it shows up
-- in the plsfrof o/p.
...
create directory Plshprof as
 'C:\Bllewell\Work\OpenWorld_And_OUG_Events\2008_OOW_SF\Using_The_Plsql_Hierarchical_Performance_Profiler\Code\Trace\Demo_0_Using_NDS'
/
...
create package body Pkg is
  ...
  begin
    ...
    declare
      type t is table of All_Objects.Object_Name%type;
      Names t;
    begin
      ...
      from All_Objects o
      where o.Object_Name like '%A%';
      if Names.Count() < 1 then raise Program_Error; end if;
